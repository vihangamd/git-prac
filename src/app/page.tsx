...
// import ClockChart from "@/component/charts";
...
//   return (
//     <div className="p-6 max-w-md mx-auto content-center">
...
//       </ul>
//       <ClockChart
//         startTime={{ hours: 4, minutes: 30, period: "PM" }}
//         endTime={{ hours: 2, minutes: 45, period: "AM" }}
//         showAllNumbers={true}
//       />
//     </div>
//   );
    ...
    <div className="p-6 mx-auto max-w-7xl bg-stone-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 items-center">
        {mockCards.map((card, index) => (
          // <div
          //   key={index}
          //   className="flex w-[250px] flex-col gap-4 rounded-lg bg-white p-3 shadow-md transition-transform duration-200 hover:scale-105 dark:bg-gray-700"
          // >
